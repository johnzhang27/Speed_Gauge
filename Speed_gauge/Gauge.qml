...
//gauge.value is what I'm looking for!!!!
CircularGauge {
    id: gauge
    ...
    style: CircularGaugeStyle {
        ...
        background: Rectangle {
            ...
            Canvas {
                ...
                function degreesToRadians(degrees) {
                    // 150 the glow is behind needle, 200 the glow is front of needle.
                ...
                onPaint: {
                    ...
                    ctx.arc(outerRadius,
                          outerRadius,
                            //Change to 3 will become a square.
        ...
        foreground: Item {
            Text {
                id: speedLabel
                anchors.centerIn: parent
                //Decimal, ex tofixed(1) means 1.0, tofixed(2) means 2.0
